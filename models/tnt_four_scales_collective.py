...
from models.zoom_transformer import ZiT
from models.zoom_transformer import ZoT
from models.zoom_transformer import Transformer
...
class TNT_Block(Module):
    def __init__(self, args, d_model):
        ...
        #self.inner_tblock = ZiT(num_person=args.N, num_point=args.J, num_head=args.innerTx_nhead, graph=args.graph, graph_args=args.graph_args)
        self.inner_tblock = TransformerEncoderLayer(d_model, args.innerTx_nhead, args.innerTx_dim_feedforward,args.innerTx_dropout, args.innerTx_activation)
        #self.inner_tblock = ZoT(num_class=args.num_classes, num_head=args.innerTx_nhead)
        #self.inner_tblock = Transformer(d_model, args.innerTx_nhead, args.innerTx_dim_feedforward,args.innerTx_dropout, args.innerTx_activation)
        
        self.inner2middle = Joint_To_Person(args, args.N, args.J, d_model)
        
        #self.middle_tblock = ZiT(num_person=args.N, num_point=args.J, num_head=args.middleTx_nhead, graph=args.graph, graph_args=args.graph_args)
        self.middle_tblock = TransformerEncoderLayer(d_model, args.middleTx_nhead, args.middleTx_dim_feedforward, args.middleTx_dropout, args.middleTx_activation)
        #self.middle_tblock = ZoT(num_class=args.num_classes, num_head=args.middleTx_nhead)
        
        self.middle2coarse = Person_To_PersonInteraction(args, args.N, args.J, d_model)
        
        #self.outer_tblock = ZiT(num_person=args.N, num_point=args.J, num_head=args.outerTx_nhead, graph=args.graph, graph_args=args.graph_args)
        self.outer_tblock = TransformerEncoderLayer(d_model, args.outerTx_nhead, args.outerTx_dim_feedforward, args.outerTx_dropout, args.outerTx_activation)
        #self.outer_tblock = ZoT(num_class=args.num_classes, num_head=args.outerTx_nhead)
        
        self.middle2group = Person_To_Group(args)
        
        #self.group_tblock = ZiT(num_person=args.N, num_point=args.J, num_head=args.groupTx_nhead, graph=args.graph, graph_args=args.graph_args)
        self.group_tblock = TransformerEncoderLayer(d_model, args.groupTx_nhead, args.groupTx_dim_feedforward,args.groupTx_dropout, args.outerTx_activation)
        #self.group_tblock = ZoT(num_class=args.num_classes, num_head=args.groupTx_nhead)
...
class Person_To_Group(Module): 
    ...
    def forward(self, person_feats_thisbatch_proj):
        ...
        #print("group_track_feats_thisbatch_proj.shape")
        #print(group_track_feats_thisbatch_proj.shape)
